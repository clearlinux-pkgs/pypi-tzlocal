...
Source0  : https://files.pythonhosted.org/packages/33/cc/11360404b20a6340b9b4ed39a3338c4af47bc63f87f6cea94dbcbde07029/tzlocal-5.3.tar.gz
...
%prep
%setup -q -n tzlocal-5.3
cd %{_builddir}/tzlocal-5.3
pushd ..
cp -a tzlocal-5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739462360
