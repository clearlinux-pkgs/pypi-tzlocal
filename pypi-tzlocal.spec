...
Source0  : https://files.pythonhosted.org/packages/8b/2e/c14812d3d4d9cd1773c6be938f89e5735a1f11a9f184ac3639b93cef35d5/tzlocal-5.3.1.tar.gz
...
%prep
%setup -q -n tzlocal-5.3.1
cd %{_builddir}/tzlocal-5.3.1
pushd ..
cp -a tzlocal-5.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741275828
